...
DEFAULT_CONFIG = {
    ...
    "ui": {
        ...
        "prompt_suggestions": [
            {
            "title": ["How many assets do I have?", "total count of assets"],
            "content": "How many assets do I have?",
        },
        {
            "title": ["Show me my assets in Chicago", "assets at a location"],
            "content": "Show me my assets in Chicago",
        },
        {
            "title": ["Due on maintenance?", "maintenance"],
            "content": "Show me a list of assets due for maintenance",
        }
        ],
    },
}
